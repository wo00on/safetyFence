...
// KST (한국 시간) 기준으로 오늘 날짜 문자열 생성 (예: "2025-10-24")
const kstOffset = today.getTimezoneOffset() * 60 * 1000 + (9 * 60 * 60 * 1000);
...
const MOCK_SCHEDULES: Schedule[] = [
  ...
  },
  {
    ...
    startTime: '09:00',
    endTime: '18:00',
    date: '2025-10-20', // 지난 월요일 (테스트용)
    type: 'temporary',
  },
];

// --- 캘린더 날짜 유틸리티 (수정: trailing null로 7의 배수 보장) ---
const getDaysInMonth = (date: Date) => {
  ...
  // 마지막 주를 채워서 항상 7의 배수가 되도록 함 (줄 깨짐 방지)
...
const CalendarPage: React.FC = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-100">
      ...
      {/* 2. <View>를 <ScrollView>로 변경 */}
      <ScrollView 
        style={{ flex: 1 }}
        contentContainerStyle={{ paddingBottom: 100 }} // 하단 네비게이션 겹침 방지
      >
        ...
        {/* 3. <FlatList>를 감싸던 View에서 flex: 1 제거 */}
        <View style={{ paddingHorizontal: 16 }}>
            <View className="flex-row items-center justify-between mb-3 px-1">
              ...
              <TouchableOpacity
                className="flex-row items-center bg-blue-600 px-3.5 py-2 rounded-lg shadow-sm"
...
const formatDate = (dateStr: string) => {
  ...
  // UTC 기준이 아닌 로컬 시간 기준으로 Date 객체 생성
